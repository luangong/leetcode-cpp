...
ABSL_FLAG(std::string, testcases, "", "Relative path to testcases.json");
...
int main(int argc, char **argv) {
   ...
   * during the test preparation phase we will load a JSON file to which the path is
  ...
  // std::cout << "--testcases = " << absl::GetFlag(FLAGS_testcases) << std::endl;
